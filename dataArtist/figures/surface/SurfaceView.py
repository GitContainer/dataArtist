...
class _SurfaceView(View3d):
    ...
    def setData(self, data):
        ...
        def psi(i, j, k, offset=(25, 25, 50)):
            ...
            r = (x**2 + y**2 + z **2)**0.5
            a0 = 1
            ps = (old_div(1.,81.)) * 1./(6.*np.pi)**0.5 * (old_div(1.,a0))**(old_div(3,2)) * (old_div(r,a0))**2 * np.exp(old_div(-r,(3*a0))) * (3 * np.cos(th)**2 - 1)
            return ps
        ...
        verts, faces = pg.isosurface(data, old_div(data.max(),4.))
