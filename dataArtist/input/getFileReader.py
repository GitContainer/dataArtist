...
# TODO: default argument is mutable: Default argument values are
# evaluated only once at function definition time,
# which means that modifying the default value of the argument
